-- Created By me! (XPLODA, MAIKEL233)  - www.X-HOOK.XYZ
-- A Faster guild inviter.
...
local TOETANCHAMON_TITLE = "TOETANCHAMON_HELPER";

function Toetanchamon_OnLoad()
	...
	-- Display our simple chat message.
	if ( DEFAULT_CHAT_FRAME ) then
		DEFAULT_CHAT_FRAME:AddMessage(TOETANCHAMON_TITLE.." AddOn loaded.  Join the Toetanchamon guild today!");
	end
